...
<div class="content">
	<div class="content_botbg">
		<div class="content_res">
			<div id="breadcrumb">
				<div id="crumbs">
					<a href=" <?php echo base_url();?>">Accueil</a> &raquo; <?php echo $section -> section;?><span class="current"></span>
				</div>
			</div>
			<!-- left block -->
			<div class="content_left">
				<div class="shadowblock_out">
					<div class="shadowblock">
						<h1 class="single dotted">Listing des <?php echo $section -> section . ' (' . $nombre;?>)</h1>
						<p>
