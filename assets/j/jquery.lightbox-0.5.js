    ...
    (function($) {
    	...
    	$.fn.lightBox = function(settings) {
    		...
    		settings = jQuery.extend({
    			...
    			imageLoading:			ref+'/assets/i/slider/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			ref+'/assets/i/slider/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			ref+'/assets/i/slider/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			ref+'/assets/i/slider/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				ref+'/assets/i/slider/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
